  ...
  const projects = [
    {
      image: image5,
      title: "QuickBite NG",
      desc: "QuickBite NG is a modern online food ordering platform that connects customers with delicious meals, offering a seamless browsing, ordering, and delivery experience.",
